...
//        color = '#78ff00c7';
    ...
    detectedObjects[imageId]['detections'].forEach((obj, index) => {
        ...
        html += `
            <div class="object-item fade-in" id="object-${index}" data-index="${index}">
                ...
                <button class="toggle button-scale" type="button" data-index="${index}">
                ...
                <button class="toggle toggle-visible" type="button" visibility="true" data-index="${index}">
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (detectedObjects[imageId] && detectedObjects[imageId]['detections'][index]) {
                const obj = detectedObjects[imageId]['detections'][index];
                // Вызываем метод масштабирования к объекту
                viewer.focusOnBBox(obj.bbox);
            }
        });
    });
